...
class TestSaleProcurementGroupByLine(TransactionCase):
    ...
    def _create_product(self, name):
        product = self.product_model.create({"name": name, "categ_id": self.product_ctg.id, "type": "product"})
        return product
    ...
    def test_05_merged_stock_moves_from_same_procurement(self):
        ...
        self.assertEqual(len(self.sale.picking_ids), 1, "Negative stock move should me merged")
